...
class Session {
  ...
  _returnData(retData, def = {}) {
    if (retData.status !== 200) {
      return Boom$1.badRequest(_.get(retData, 'message', 'No error message reported!'))
    } else {
      return _.get(retData, 'data', def);
    }
  }
...
class Documents {
  ...
  _returnData(retData, def = {}) {
    if (retData.status !== 200) {
      throw Boom$1.badRequest(_.get(retData, 'message', 'No error message reported!'))
    } else {
      return _.get(retData, 'data', def);
    }
  }
