...
**Returns**: <code>Promise.&lt;object&gt;</code> - data<code>string</code> - _id the id of the form<code>string</code> - orgId the organization id of the form<code>string</code> - responseToken the unique token registered internally by the system for all the next calls to the external form APIs     The responseToken is unique and is ONLY valid for this session.<code>array.&lt;object&gt;</code> - groups the form groups to render  
**Access**: public  
**Author**: CloudBrasil <abernardo.br@gmail.com>  
